...
@SpringBootTest
@AutoConfigureMockMvc		// tras um novo contexto web 
@ActiveProfiles("test")
public class EmpresaControllerTest {
	
	@Autowired
	private MockMvc mvc;		// funcionara como um container web.
	...
	public void testBuscarEmpresaCnpjInvalido() throws Exception {
		BDDMockito.given(this.empresaService.searchByCnpj(Mockito.anyString())).willReturn(Optional.empty());
	...
	public void testBuscarEmpresaCnpjValido() throws Exception {
		BDDMockito.given(this.empresaService.searchByCnpj(Mockito.anyString()))
	...
	private Company obterDadosEmpresa() {
		...
		empresa.setId(ID);
		empresa.setCompanyName(RAZAO_SOCIAL);
